...
using SMS_MD.Entities.StoredProcedures;
using System;
...
{
    public partial class SMSMDContext
    {
        private ISMSMDContextProcedures _procedures;

        public virtual ISMSMDContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new SMSMDContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public ISMSMDContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class SMSMDContextProcedures : ISMSMDContextProcedures
    {
        private readonly SMSMDContext _context;

        public SMSMDContextProcedures(SMSMDContext context)
        {
            _context = context;
        }
